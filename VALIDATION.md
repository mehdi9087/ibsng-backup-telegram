...
- Coverage includes delivery failures, retention, local-only backups, automatic detection, installation rollback, offline scheduling, disabled-state preservation, embedded source consistency, integrity verification, restore confirmation and safeguards, maintenance locks, and uninstall with removal of active and archived settings while preserving database backups and unrelated files.
